 export const enum CalendarDataTeatId {
     ...
     MODAL_DRAWER_RIGHT_INPUT_EXERCISE_INDEX = 'modal-drawer-right-input-exercise', //data-test-id=`modal-drawer-right-input-exercise${index}` Где индекс, соответственно, индекс элемента при мапинге упражнений.
     MODAL_DRAWER_RIGHT_CHECKBOX_EXERCISE_INDEX = 'modal-drawer-right-checkbox-exercise', //modal-drawer-right-checkbox-exercise${index}
     MODAL_DRAWER_RIGHT_INPUT_APPROACH_INDEX = 'modal-drawer-right-input-approach', //modal-drawer-right-input-approach${index}
