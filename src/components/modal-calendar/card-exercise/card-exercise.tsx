...
const CardExercise = ({
    ...
    const [newExercises, setNewExercises] = useState<ExerciseType[]>(
        getExercises(selectedTraining, currentTrainings),
    );
            ...
            <Card
                ...
                actions={[
                    <div key='actionAddTraining' className='card-training__actions-wrapper'>
                        ...
                        <Button
                            disabled={newExercises.length === 0 && !isEditTraining}
                            type='text'
                            size='middle'
                            onClick={handleSave}
                        >
                ...
                <Meta
                    title={
                        <div className='card-exercise__title-wrapper'>
                            <Button
                                data-test-id={
                                    CalendarDataTeatId.MODAL_EXERCISE_TRAINING_BUTTON_CLOSE
                                }
                                type='text'
                                size='small'
