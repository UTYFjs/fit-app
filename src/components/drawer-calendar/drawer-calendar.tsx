        ...
        >
            <div className='drawer-wrapper'>
                <div className='drawer-calendar__badge'>
                    <BadgeTraining text={selectedTraining} isGray={true} />{' '}
                    <span className='drawer-calendar__date'>{date}</span>
                </div>
                    ...
                    {exercises.map(({ approaches, weight, replays, name }, index) => (
                        <fieldset key={index} className='exercise-item'>
                            <Input
                                ...
                                onChange={(e) => {
                                    handleOnChangeName(e.target.value, index);
                                }}
                            />
                            <div className='exercise-item__values'>
                                <div>
                                    ...
                                    <InputNumber
                                        ...
                                        value={approaches}
                                        onChange={(value) => {
                                            handleOnChangeApproaches(value || 1, index);
                                        }}
                                    />
                                </div>
                                <div className='exercise-item__values_second'>
                                    <div>
                                        ...
                                        <InputNumber
                                            ...
                                            value={weight}
                                            onChange={(value) => {
                                                handleOnChangeWeight(value || 0, index);
                                            }}
                                        />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <InputNumber
                                            ...
                                            value={replays}
                                            onChange={(value) => {
                                                handleOnChangeReplays(value || 1, index);
                                            }}
                                        />
                                    </div>
                                </div>
